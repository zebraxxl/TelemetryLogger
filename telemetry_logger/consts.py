...
ALL_TELEMETRY = frozenset({
    ...
    TELEMETRY_NET_IO_COUNTERS, TELEMETRY_NET_IO_COUNTERS_PER_NIC, TELEMETRY_NET_CONNECTIONS,


    TELEMETRY_PROCESS_CPU_AFFINITY,

    TELEMETRY_PROCESS_MEM_INFO, TELEMETRY_PROCESS_MEM_PERCENT, TELEMETRY_PROCESS_MEM_MAP,

    TELEMETRY_PROCESS_DISK_OPEN_FILES,

    TELEMETRY_PROCESS_NET_CONNECTIONS,
})
